    ...
    this.formItem2 = [    
      {
        ...
        editorOptions: {
          stylingMode: 'filled',
          readOnly: (rowData.data.status != "در انتظار تایید"),
      ...
      },
      {
        ...
        colCount: 2,
        label: {
          text: (rowData.data.status != "در انتظار تایید") ? "وضعیت فرم" : "آیا اطلاعات و مشخصات فرم را تایید می کنید؟",
        },
        items: [
          {
            visible: (rowData.data.status == "در انتظار تایید"),
            editorType: 'dxButton',
            editorOptions: {
              width: '100%',
              icon: 'check',
